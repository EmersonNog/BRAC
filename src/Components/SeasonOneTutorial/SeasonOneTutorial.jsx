    ...
    <div className="dark-page">
      <section className="season1-tutorial">
        ...
        <div className="season-lore-scroll">
          ...
          <p>
            Em um passado recente, durante a Corrida Biotecnológica Secreta, uma
            divisão militar desenvolveu um patógeno experimental com o objetivo
            de criar soldados imunes à dor, ao medo e à obediência. O projeto,
            batizado de <strong>Crimson Protocol</strong>, saiu do controle
            quando sua cobaia mais promissora — uma estrategista brilhante
            chamada Dra. Yelena Voss — sofreu mutação completa.
          </p>
          <p>
          ...
          <p>
            ...
            evoluídas. As cidades se tornaram campos de guerra genético-militar.
            Fortalezas estratégicas são disputadas diariamente, enquanto a
            infecção se infiltra até nos sistemas de defesa.
          </p>
          <p>
            É nesse cenário que a BRAC assume o protagonismo. Sua inteligência
            coletiva, disciplina em rede e domínio tático transformaram um grupo
            de sobreviventes em uma força ofensiva de elite. A vitória dependerá
            da cooperação, da estratégia e da coragem de seus comandantes. A
            guerra pelo futuro começou — e ela carrega o nome de{" "}
            <strong>The Crimson Plague</strong>.
          </p>
        </div>

        <p className="intro">
          Domine a primeira grande temporada de <strong>Last War</strong> com
          estratégias avançadas, dicas para iniciantes e tudo o que você precisa
          saber sobre eventos, recompensas e evolução. Preparado, comandante?
        </p>
        ...
        <div className="section">
          ...
          <ul>
            <li>
              <strong>Suba sua resistência ao vírus</strong>: Foque no Instituto
              Viral e missões semanais.
            </li>
            <li>
            ...
            <li>
              <strong>Use toda a stamina</strong>: Eventos como Purge Action não
              têm limite de baús.
            </li>
          </ul>
        </div>
        ...
        <div className="section">
          ...
          <ul>
            ...
            <li>
              Distribua profissões: engenheiros para suporte, líderes para PvP.
            </li>
            <li>Troque fragmentos organizadamente (use Discord/WhatsApp).</li>
            <li>Coordene guerras de cidades (1 hora por cidade, 2 por dia).</li>
          </ul>
        </div>
        ...
        <div className="section">
          ...
          <p>
            Capture uma <strong>Fortaleza Militar</strong> para declarar guerra
            em cidades vizinhas.
          </p>
        </div>
